...
public interface UserService {
    ...
    List<CommentDto> getAllCommentsByPostId(Long postId, Pageable page);

    List<CommentDto> getAllCommentsByUserId(Long userId, Pageable page);
    ...
    List<PostDto> getAllPostsByUserId(Long userId, Pageable page);
