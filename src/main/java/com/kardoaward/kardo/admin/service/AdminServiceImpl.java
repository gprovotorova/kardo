...
public class AdminServiceImpl implements AdminService {
    ...
    public EventDto createEvent(Long userId, EventDto eventDto) {
        ...
        if(eventRepository.existsByName(event.getId())){
            throw new ObjectExistException("Мероприятие с таким названием уже существует");
        }
    ...
    public void deleteEvent(Long userId, Long eventId) {
        ...
        if(eventRepository.existsById(eventId)){
            ...
            throw new ObjectNotFoundException("Мероприятия с таким id не существует");
        }
    }
    ...
    public void deletePartner(Long partnerId) {
        if(partnerRepository.existsById(partnerId)){
            ...
            throw new ObjectNotFoundException("Партнера с таким id не существует");
        }
    }
    ...
    public StreamDto updateStream(Long streamId, StreamDto streamDto) {
        ...
        stream.setPublishedDate(LocalDate.now());
